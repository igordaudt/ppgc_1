# modelo_rf.py
# Classificação de materiais de construção usando Random Forest
...
METRICS_TXT = METRIC_DIR / "rf_metrics.txt"
REPORT_TSV  = METRIC_DIR / "rf_class_report.tsv"
CM_PNG      = FIG_DIR / "rf_confusion_matrix.png"
...
def build_model():
    ...
    model = RandomForestClassifier(
        ...
        random_state=42,
        class_weight=None     # pode ser ajustado para lidar com desbalanceamento
    )
    return model
