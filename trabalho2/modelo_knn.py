# modelo_knn.py
# Classificação de materiais de construção usando K-Nearest Neighbors (KNN)
...
MODEL_PKL   = MODEL_DIR / "knn_model.pkl"
METRICS_TXT = METRIC_DIR / "knn_metrics.txt"
REPORT_TSV  = METRIC_DIR / "knn_class_report.tsv"
CM_PNG      = FIG_DIR / "knn_confusion_matrix.png"
...
def build_model():
    """Cria o modelo KNN com hiperparâmetros padrão."""
    model = KNeighborsClassifier(
        n_neighbors=5,       # número padrão de vizinhos
        weights="distance",  # vizinhos mais próximos têm mais peso
        metric="cosine",     # similaridade de cosseno funciona bem para TF-IDF
