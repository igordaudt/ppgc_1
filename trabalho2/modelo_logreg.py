# modelo_logreg.py
# Classificação de materiais de construção usando Regressão Logística
# Estrutura padronizada para todos os modelos do trabalho (Trabalho 2 - Aprendizado de Máquina)
...
MODEL_PKL   = MODEL_DIR / "logreg_model.pkl"
METRICS_TXT = METRIC_DIR / "logreg_metrics.txt"
REPORT_TSV  = METRIC_DIR / "logreg_class_report.tsv"
CM_PNG      = FIG_DIR / "logreg_confusion_matrix.png"
...
def build_model():
    """Cria o modelo de Regressão Logística com hiperparâmetros padrão."""
